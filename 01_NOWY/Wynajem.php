...
<body style="background-color: rgb(255, 206, 71)">
    ...
    <div class="container">
        <div class="row col-md-12">
            ...
            <a href="RentPassat.php"> <img  src="Passat.png" alt="Info"></a>
            </div>
            <div class="col-md-6 text-center">
            <a href="Rent500.php"> <img  src="500.png" alt="Info"></a>
            </div>
        </div>
        <div class="row col-md-12">
            <div class="col-md-6 text-center">
            <a href="RentJuke.php"> <img  src="Juke.png" alt="Info"></a>
            </div>
            <div class="col-md-6 text-center">
            <a href="RentCHR.php"> <img  src="CHR.png" alt="Info"></a>
            </div>
        </div>
    </div>
